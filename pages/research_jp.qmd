...
- **Mana Sakai**, Ryo Karakida, and Masaaki Imaizumi. (2025). Infinite-Width Limit of a Single Attention Layer: Analysis via Tensor Programs. In *Advances in Neural Information Processing Systems*, to appear.
[[arXiv](https://arxiv.org/abs/2506.00846){target="_blank"},
[コード](https://github.com/manasakai/infinite-width-attention){target="_blank"}]
    <br>
    <small>
...
- **Mana Sakai**, Takeru Matsuda, and Tatsuya Kubokawa. (2024). Priors for second-order unbiased Bayes estimators. *Biometrika*, accepted.
[[arXiv](https://arxiv.org/abs/2412.19187){target="_blank"},
[コード](https://github.com/manasakai/second-order-unbiased-NER){target="_blank"},
